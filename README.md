...
NB. А вы точно уверены, что квантовых компов с архитектурой фон Неймановского типа не сделают(-ли), что позволит сделать модификацию алгоритма Гровера с оценкой числа итераций **O(log(2^n))** или просто **O(n)** - ведь и про факторизацию чисел много говорили, что это технически невозможно и сложно ... хо-хо-хо ?
